...
const testCases = [
	...
	{
		desc: 'returns true when one value is null',
		amount1: null,
		amount2: '0',
		result: true,
	},
	{
		desc: 'returns true when both are null',
		amount1: null,
		amount2: null,
		result: true,
	},
	{
		desc: 'returns true when both are empty strings',
		amount1: '',
		amount2: '',
		result: true,
	},
	{
		desc: 'returns true when one is empty string and another is numeric 0',
		amount1: '',
		amount2: 0,
		result: true,
	},
	{
		desc: 'returns true when one is empty string and another is string 0',
		amount1: '',
		amount2: '0',
		result: true,
	},
